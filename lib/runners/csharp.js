    ...
    shovel.start(opts, cb, {
        ...
        testIntegration: function (runCode, fail) {
            ...
            compile(args, function (error, stdout, stderr) {
                ...
                //     'mcs',
                //     '-out:' + exe,
                //     `-lib:/runner/frameworks/csharp/mono-4.5,${nunitPath}`,
                //     '-warn:2',
                //     '-sdk:4.5',
                //     '-target:exe',
                //     `-r:${nunitAssemblies}`,
                //     '-r:System.Drawing.dll',
                //     '-linkresource /runner/frameworks/csharp/nunit/App.config',
                //     '/runner/frameworks/csharp/nunit/AssemblyInfo.cs',
                //     '/runner/frameworks/csharp/nunit/Entry.cs',
                //     '/runner/frameworks/csharp/nunit/ConsoleUi.cs',
                //     '/runner/frameworks/csharp/nunit/Display.cs',
                //     '/runner/frameworks/csharp/nunit/EventCollector.cs',
                //     '/runner/frameworks/csharp/nunit/ConsoleOptions.cs',
                //     '/runner/frameworks/csharp/nunit/Runner.cs'
