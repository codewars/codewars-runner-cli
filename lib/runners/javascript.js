...
module.exports.run = function run(opts, cb) {
  shovel.start(opts, cb, {
    ...
    files: function() {
      ...
      writeFilesSync(opts.dir, opts.files, true, function(name, content) {
...
function runMocha(opts, interfaceType, runCode, file) {
  var args = ['/.npm-global/bin/mocha', '-t', opts.timeout || 8000, '-u', interfaceType, '-R', '/runner/frameworks/javascript/mocha-reporter.js', file];
