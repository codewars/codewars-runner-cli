...
module.exports.run = function run(opts, cb) {
    shovel.start(opts, cb, {
        solutionOnly: function () {
            ...
            return {name: 'runhaskell', 'args': ['-iframeworks/haskell', solutionFile]};
        },
        fullProject: function () {
            haskellWriteSync(opts.solution);
            if (opts.setup) haskellWriteSync(opts.setup);
            return {name: 'runhaskell', 'args': ['-iframeworks/haskell', haskellWriteSync(opts.fixture, "TestFixture.hs")]};
        }
    });
};
