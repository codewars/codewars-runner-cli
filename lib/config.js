    ...
    snippets: {
        ...
        php: {
            bootstrap: [
                ...
                "require_once('frameworks/php/Codewars/TestCase.php');",
                "require_once('frameworks/php/Codewars/TestRunner.php');",
            ].join('\n'),
            classBegin: [
            ...
            execute: [
                ...
                "$test = new KataTest('testSolution');",
                "$suite->addTest($test);",
                "$result = CodeWars\\TestRunner::run($suite, ['configuration' => 'frameworks/php/phpunit.xml']);",
                "echo $test->getCwResults();",
                "exit((int)$test->hasFailed());"
            ].join('\n')
        }
    }
};
