...
function FileTools(from, to, filter) {
  this.from = from;
  this.to = to;
  this.filter = filter || function(state, filepath, filename) { // eslint-disable-line no-unused-vars
    return true;
  };
  return this;
}
...
function copy(from, to, filter, callback) {
  ...
  tools.find(function(err, list) {
    ...
    tools.mkdir(dirs, function(err) { // eslint-disable-line no-unused-vars
